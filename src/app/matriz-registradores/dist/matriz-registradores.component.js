...
var MatrizRegistradoresComponent = /** @class */ (function () {
    ...
    __decorate([
        core_1.Input()
    ], MatrizRegistradoresComponent.prototype, "registradoresArray");
    MatrizRegistradoresComponent = __decorate([
        core_1.Component({
    ...
    return MatrizRegistradoresComponent;
}());
exports.MatrizRegistradoresComponent = MatrizRegistradoresComponent;
