        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    _a.label = 1;
                case 1:
                    if (!(i < linhasArray.length)) return [3 /*break*/, 5];
                    lineParts = linhasArray[i].split(' ');
                    if (!(lineParts[0].charAt(0) !== '#' && lineParts[0].charAt(0) !== ':')) return [3 /*break*/, 3];
                    norma_global_objects_util_1.setLinhaAtual(i);
                    // ----------------------------------- //
                ...
                case 2:
                    ...
                    _a.label = 3;
                case 3:
                    if (norma_global_objects_util_1.getStopped()) {
                        return [3 /*break*/, 5];
                    }
                    _a.label = 4;
                case 4:
                    ...
                    return [3 /*break*/, 1];
                case 5:
                    norma_global_objects_util_1.setExecuting(false);
                    norma_global_objects_util_1.setStopped(false);
                    norma_global_objects_util_1.setExecutionComplete(true);
                    return [2 /*return*/];
            }
        });
    });
